...
export default function CongressInfo({ paymentEnabled, activeTicket, passiveTicket }: { paymentEnabled:boolean; activeTicket?: {price:number}; passiveTicket?: {price:number} }) {
  return (
    <>
