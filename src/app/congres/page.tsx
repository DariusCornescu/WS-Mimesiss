    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 space-y-10">
        ...
        <div className="mimesiss-card flex flex-col gap-2 p-6 space-y-4">
          <h1 className="font-bold uppercase tracking-tight text-center text-accent mb-2">BALUL BOBOCILOR 2026</h1>
          <div className="mx-auto mb-4 h-px w-24 bg-gradient-to-r from-primary to-secondary" />

          <p className="text-center font-mono text-xs uppercase tracking-[0.3em] text-primary">Asociația Studenților în Medicină Militară</p>
          ...
          <div className="border-t border-border/30 pt-4 mt-4">
            <p className="text-center text-sm text-muted-foreground leading-relaxed mb-3">
